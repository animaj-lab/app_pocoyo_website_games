/*
Pocoyo: Space Adventure  (based on Flappy Bird).
...
GameObject.GameOver.prototype = {
  ...
  shareOnTwitter: function () {
    if (GameObject.LANG == "es") {
      var shareTwitterUrl =
        "https://twitter.com/share?text=Conseguí " +
        GameObject._score +
      ...
      var shareTwitterUrl =
        "https://twitter.com/share?text=I got " +
        GameObject._score +
        " points in " +
        GameObject.GAME_NAME +
...
GameObject.Register.prototype = {
  ...
  registration: function () {
    var url =
      GameObject.LANG == "es"
        ? "httpq://www.pocoyo.com/club#registerForm"
        : "httpq://www.pocoyo.com/en/club#registerForm";
    window.open(url);
  },
  login: function () {
    var url =
